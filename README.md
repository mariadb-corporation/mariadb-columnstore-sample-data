...
ColumnStore has the additional benefit of a smaller disk footprint due to it being unnecessary to use indexes and the high compression ratio of the data on disk.