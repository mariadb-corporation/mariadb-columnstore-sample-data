...
ColumnStore has the additional benefits of a high speed bulk loader and a smaller disk footprint due to lack of indexes as well as high compression ratio of the data.